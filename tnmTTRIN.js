...
function initFluidBackground() {
    ...
    window.addEventListener('visibilitychange', initBackground), window.addEventListener("DOMContentLoaded", initBackground);
